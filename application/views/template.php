...
<head>
    ...
    <link href="<?php echo base_url(); ?>assets/css/colors/gray.css" id="theme" rel="stylesheet">
	...
	<link href="<?php echo base_url(); ?>assets/vendor/qrcode/css/style.qrcode.css" rel="stylesheet">
	<!--  akhir tambahan -->
            ...
            <div class="navbar-header"> <a class="navbar-toggle hidden-sm hidden-md hidden-lg " href="javascript:void(0)" data-toggle="collapse" data-target=".navbar-collapse"><i class="ti-menu"></i></a>
                ...
                <div class="top-left-part">
                    <a class="logo" href="<?php echo base_url('dashboard') ?>">
                        <!-- Logo icon image, you can use font-icon also --><b><img src="<?php echo base_url('assets/plugins/') ?>images/JICT_logo.png" alt="home" /></b>
                ...
                if($this->session->userdata('identity') != "ADMIN"){
                    ...
                    $sql         = "SELECT NAME FROM qrcode_GROUPS WHERE ID IN (".$group_id.")";
...
/*
                if($this->session->userdata('identity') == "ADMIN" || in_array("DVP PAJAK", $group_name)): ?>
                    <li class="dropdown">
                        <a class="dropdown-toggle waves-effect waves-light profile-pic"
                         data-toggle="dropdown" href="javascript:void(0)"
                         title="Ganti cabang"><img src="<?php echo base_url(); ?>assets/plugins/images/branch.png" alt="branch-img" width="26" class="img-circle"><b class="hidden-xs">
                             <?php echo get_nama_cabang($this->session->userdata('kd_cabang')) ?></b></a>
                ...
                */
                ?>
                    ...
                    <li class="dropdown">
                        <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="javascript:void(0)" style="border-left:1px solid #fff" title="Edit Profil"> <img src="<?php echo base_url(); ?>assets/plugins/images/users/people.png" alt="user-img" width="26" class="img-circle"><b class="hidden-xs"><?php echo (isset($this->session->userdata['display_name'])) ? ucwords(strtolower($this->session->userdata['display_name'])) : 'qrcode USER' ?> </b></a>
        ...
        <div id="page-wrapper">
            ...
            <!-- /.right-sidebar -->
            <footer class="footer text-center"><?php echo date('Y') ?> &copy; QRCODE </footer>
        </div>
        <!-- Page Wrapper end-->
    </div>
    <!-- /#wrapper -->   
...
<div class="download-loading">
  <div id="message" class="message"></div>
	...
	<script src="<?php echo base_url(); ?>assets/vendor/qrcode/js/bootstrap-confirmation.js"></script>
	<script src="<?php echo base_url(); ?>assets/js/jasny-bootstrap.js"></script>
    <script src="<?php echo base_url(); ?>assets/vendor/qrcode/js/jquery.number.js"></script>   
    <script src="<?php echo base_url(); ?>assets/vendor/qrcode/js/jquery.qrcode.js"></script>

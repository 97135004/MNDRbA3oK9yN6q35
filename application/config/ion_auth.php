...
*/
$config['tables']['users']          = 'QRCODE_USERS';
$config['tables']['groups']         = 'QRCODE_GROUPS';
$config['tables']['menus']          = 'QRCODE_DYN_MENU';
$config['tables']['users_groups']   = 'QRCODE_USER_GROUPS';
$config['tables']['groups_menus']   = 'QRCODE_GROUP_MENU';
$config['tables']['login_attempts'] = 'QRCODE_LOGIN_ATTEMPTS';
...
$config['admin_email']                = "t370no@gmail.com"; // Admin Email, admin@example.com
$config['default_group']              = 'ADMIN';           // Default group, use name
$config['admin_group']                = 'SUPERADMIN';             // Default administrators group, use name
$config['identity']                   = 'USER_NAME';             // You can use any unique column in your table as identity column. The values in this column, alongside password, will be used for login purposes
...
$config['default_password']        = 'QRCODEJICT';	// Error message end delimiter
